...
export default function Error() {
  ...
  return (
    <>
      ...
      <div
        aria-live="assertive"
        className="nightwind-prevent nightwind-prevent-block z-10 pointer-events-none fixed inset-0 flex items-end px-4 py-6 sm:items-start sm:p-6"
      >
              ...
              <div className="p-4">
                <div className="flex items-start">
                  ...
                  <div className="ml-3 w-0 flex-1 pt-0.5">
                    <h2 className="text-sm font-medium text-gray-900">Error!</h2>
                    {error && error.message &&
